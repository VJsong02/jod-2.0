...
payments = { 
    ...
    # 2021 - 2022
    date(2020,  8, 30): (7616,  3312 - 150),  # uppläggningsavgift
    date(2020,  9, 24): (7616,  3312),
    date(2020, 10, 25): (7616,  3312),
    date(2020, 11, 25): (7616,  3312),
    date(2020, 12, 23): (7616,  3312),
    date(2021,  1, 17): (11424, 4968 - 150),  # uppläggningsavgift
    date(2021,  2, 25): (7616,  3312),
    date(2021,  3, 25): (7616,  3312),
    date(2021,  4, 25): (7616,  3312),
    date(2021,  5, 25): (3808,  1656),
    date(2021,  6, 25): (0,     0),
    date(2021,  7, 25): (0,     0)
}
