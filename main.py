...
payments = { 
    ...
    date(2022, 12, 23): (7728,  3360),
    date(2023,  1, 16): (11592, 5040 - 150),  # uppläggningsavgift
    date(2023,  2, 24): (7728,  3360),
    date(2023,  3, 24): (7728,  3360),
    date(2023,  4, 25): (7728,  3360),
    date(2023,  5, 25): (3864,  1680),
}
